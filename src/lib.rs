...
#[derive(Debug)]
pub struct AgentCoreXProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AgentCoreXProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AgentCoreX processing");
    
    let mut processor = AgentCoreXProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AgentCoreXProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AgentCoreXProcessor::new(false);
